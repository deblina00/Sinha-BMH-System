...
export default function ProductsPage() {
  return (
    <>
      <PageHero
        eyebrow="Our Equipment Portfolio"
        title={<>Bulk handling machinery built for <span className="text-gradient-ember">continuous duty.</span></>}
        description="Engineered for high tonnage, extreme environments, and maximum uptime. Explore our flagship systems and accessories below."
      />
            ...
            <Reveal key={p.slug} delay={idx * 0.05}>
              <article className="group border border-border/60 bg-surface/60 hover:border-ember transition-colors flex flex-col h-full">
                ...
                <div className="p-6 flex flex-col flex-grow justify-between">
                  ...
                  >
                    View Varieties & Specs <ArrowRight size={12} />
                  </Link>
                </div>
              </article>
            </Reveal>
